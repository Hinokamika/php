                ...
                <div class="answer-form">
                        ...
                        <div class="reply-question">
                            <form action="Insert_question.php" method="POST">
                                ...
                                <ul class="button_sign">
                                    <li class="cn-btn">
                                        <button type="button" class="closeFormBtn" >Cancel</button>
                                    </li>
                                    <li class="rl-btn">    
                    ...
                    <div class="update_form up_pop" style="display: none;" >
                        ...
                        <ul class="update_button">
                            <li>
                                <button type="button" class="cn_btn close_popupbtn">Cancel</button>
                            </li>
                            <li>
                ...
                <div class="answer-form">
                    ...
                    <div class="reply-form anspopup" style="display: none;">
                        ...
                        <div class="update_form up_pop" style="display: none;">
                            ...
                            <form action="Edit_questions.php" method="POST">
                                <div class="update_input">
                                    <textarea name="answer_text" id="answer" cols="78" rows="3"><?= $question['question_text'] ?></textarea>
                                </div>
                                <ul class="update_button">
                                    <li>
                                        <button type="button" class="cn_btn close_popupbtn" >Cancel</button>
                                    ...
                                    <li>
                                        <input type="hidden" name="id" value="<?= $question['id']?>">
                                        <button type="submit" class="update_btn" name="edit_question" value="edit">Update</button>
                                    </li>
                                </ul>
                            </form>
                        </div>
